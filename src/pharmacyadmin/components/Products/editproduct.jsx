            ...
            <div className="col-sm-12">
              <div className="card">
                <div className="card-body custom-edit-service">
                  {/* Add Medicine */}
                  <form method="post" encType="multipart/form-data" autoComplete="off" id="update_service" action="/pharmacyadmin/products">
                      ...
                      <div className="row">
                        <div className="col-lg-6">
                          <div className="form-group">
                            ...
                            <input type="hidden" name="discount" id="discount" defaultValue={18} />
                            <input className="form-control" type="text" name="discount" id="discount" defaultValue required />
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="row">
                        <div className="col-lg-12">
                          <div className="form-group">
                            ...
                            <textarea id="about" className="form-control service-desc" name="about" defaultValue={""} />
                          </div>
                        </div>
                      </div>
                    </div>
