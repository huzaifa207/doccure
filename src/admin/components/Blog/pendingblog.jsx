...
class PendingBlog extends Component {
    constructor(props) {
      super(props);
      this.state = {
          show: null
          ...
          <div className="page-header">
            <div className="row">
              <div className="col-sm-12">
                <h3 className="page-title">Pending Blog</h3>
                <ul className="breadcrumb">
                  <li className="breadcrumb-item"><a href="/admin">Dashboard</a></li>
                  <li className="breadcrumb-item"><a href="">Pages</a></li>
                  <li className="breadcrumb-item active">Pending Blog</li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div className="row mb-5">
                <div className="col">
                  <ul className="nav nav-tabs nav-tabs-solid">
                    ...
                    <li className="nav-item">
                      <a className="nav-link active" href="/admin/pending-blog">Pending Blog</a>
                    </li>
                  </ul>
                </div>
                ...
                <div className="col-md-6 col-xl-4 col-sm-12">
                  ...
                  <div className="blog grid-blog">
                    ...
                    <div className="row pt-3">
                      ...
                      <div className="col text-right"><a href="" className="text-success" data-toggle="modal" data-target="#deleteNotConfirmModal"><i className="fas fa-toggle-on" /> Active</a></div>
                    </div>
                  </div>
                  {/* /Blog Post */}
                </div>
